...
@Service
public class ReaderApp extends RouteBuilder {
    ...
    public ReaderApp(final EmailProperties emailConfig, final AiProperties aiProperties) {
    ...
    public void configure() {
        ...
        from(imapUri)
            ...
            .choice()
                .when().method(EmailFilterService.class, "isAllowedSender(${header.OriginalFrom})")
